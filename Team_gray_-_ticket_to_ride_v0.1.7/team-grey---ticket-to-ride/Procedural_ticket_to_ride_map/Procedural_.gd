...
func generate_cities(count: int):
	...
	while cities.size() < count and attempts < 500:
		var pos = Vector2(randf_range(200, CANVAS_SIZE_X - 50), randf_range(50, CANVAS_SIZE_Y - 50))
		var valid = true
...
func _draw():
	draw_rect(Rect2(0, 0, CANVAS_SIZE_X, CANVAS_SIZE_Y), Color(0.9, 0.85, 0.7))
...
#Script to draw a HUD at the bottom, phased out with overlay UI
#func draw_hud(font):
#	var cards_text = ""
...
#	
#	draw_rect(Rect2(10, CANVAS_SIZE_Y - 40, CANVAS_SIZE_X - 20, 30), Color(0, 0, 0, 0.7))
#	draw_string(font, Vector2(20, CANVAS_SIZE_Y - 20), hud_text, HORIZONTAL_ALIGNMENT_LEFT, -1, 14, Color.WHITE)
